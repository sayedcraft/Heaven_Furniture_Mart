    ...
    <section className="relative overflow-hidden border-t border-[var(--line)] bg-[var(--ivory)] py-10 sm:py-15 lg:py-20">
      <div className="mx-auto w-full max-w-[1500px] px-5 sm:px-8 lg:px-12">
        ...
        <Reveal className="mb-10 text-center sm:mb-16 lg:mb-20">
          <h2
            className="
              serif mx-auto max-w-4xl text-center
              text-3xl leading-[0.95] tracking-tight
              text-[var(--deep-brown)]
              sm:text-4xl
              md:text-5xl
              lg:text-[3.2rem]
        ...
        <div className="grid items-start gap-6 sm:gap-7 lg:grid-cols-12 lg:gap-7">
            ...
            <article className="group relative">
              <div className="image-wrap relative aspect-[1.15] overflow-hidden bg-[var(--surface)] sm:aspect-[1.35] lg:aspect-[1.42]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-7 lg:p-8">
                  ...
                  <h3 className="serif text-2xl leading-none text-white sm:text-3xl md:text-4xl lg:text-[2.2rem]">
                    {hero.name}
                  </h3>
                </div>
              </div>
          ...
          <Reveal delay={140} className="lg:col-span-4">
            <div className="border-t border-[var(--line)] pt-6 sm:pt-7 lg:pt-8">
              ...
              {/* Title */}
              <h3 className="serif text-2xl leading-[1] text-[var(--deep-brown)] sm:text-3xl md:text-4xl lg:text-[2.2rem]">
                {hero.name}
              </h3>

              {/* Editorial Paragraph */}
              <p className="mt-5 max-w-md text-[0.8rem] leading-6 text-[var(--brown)] sm:mt-6 sm:text-[0.85rem] md:text-sm">
              ...
              {/* Short Description */}
              <p className="mt-4 max-w-sm text-[0.72rem] leading-5 text-[var(--brown)]/80 sm:text-[0.8rem]">
                {hero.description}
              </p>
          ...
          <Reveal className="mb-8 sm:mb-10 md:mb-12 lg:mb-14">
            <div className="flex items-end justify-between gap-5">
              <h2
                className="
                  serif
                  text-3xl leading-[0.9] tracking-tight
                  text-[var(--deep-brown)]
                  sm:text-4xl
                  md:text-5xl
                  lg:text-[3.2rem]
                ...
                <article className="group cursor-pointer">
                  ...
                  <div className="image-wrap relative aspect-[0.92] overflow-hidden bg-[var(--surface)] sm:aspect-[1.02]">
                    ...
                    <div className="absolute left-4 top-4">
                      <span className="bg-[var(--ivory)]/90 px-2.5 py-1.5 text-[0.6rem] font-bold uppercase tracking-[0.18em] text-[var(--deep-brown)] backdrop-blur-sm sm:text-[0.65rem]">
                        {item.tag}
                      </span>
                    </div>
                  ...
                  <div className="mt-4 sm:mt-5">
                    <div className="flex items-start justify-between gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <h3 className="serif text-[0.95rem] leading-none text-[var(--deep-brown)] transition-colors duration-300 group-hover:text-[var(--brass)] sm:text-xl md:text-[1.05rem] lg:text-[1.1rem]">
                          {item.name}
                        </h3>
                      </div>
                    ...
                    <p className="mt-2.5 max-w-xs text-[0.72rem] leading-5 text-[var(--brown)] sm:mt-3 sm:text-[0.8rem]">
                      {item.description}
                    </p>
                  </div>
                </article>
