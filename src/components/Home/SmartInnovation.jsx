    ...
    >
      <div className="mx-auto w-full max-w-[1500px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:items-end lg:gap-16">
          ...
          >
            <div className="group relative overflow-hidden bg-[#d6cabb]">
          ...
          <div className="grid lg:grid-cols-2">
            ...
            {innovations.map((innovation, index) => (
              <Reveal
                ...
                `}
              >
                <article className="relative min-h-[250px] overflow-hidden p-6 transition-colors duration-500 hover:bg-white sm:p-8 lg:min-h-[280px] lg:p-10">

                  {/* Background number */}
                  <span
                    aria-hidden="true"
                    className="pointer-events-none absolute -right-2 -top-7 font-serif text-[9rem] leading-none text-[var(--charcoal)]/[0.035] transition-all duration-700 group-hover:-translate-x-2 group-hover:text-[var(--brass)]/[0.08] sm:text-[11rem]"
                  >
                    {innovation.number}
                  </span>
                  ...
                  <div className="relative z-10 flex h-full flex-col justify-between">
                    ...
                    <div className="mt-14 max-w-md">
                      <h3 className="serif text-2xl leading-[1.05] text-[var(--charcoal)] sm:text-3xl">
                        {innovation.title}
                      </h3>
