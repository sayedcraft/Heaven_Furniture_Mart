...
export default function BrandIntro() {
  return (
    ...
    >
      <span className="serif pointer-events-none absolute -right-4 top-10 text-[clamp(12rem,27vw,26rem)] leading-none text-[var(--deep-brown)]/[.035]">
        2020
      </span>
      <Container>
        <div className="grid gap-10 lg:grid-cols-[.75fr_2fr] lg:gap-20">
          ...
          <Reveal className="relative z-[1]" delay={120}>
            ...
            >
              Thoughtful, bespoke furniture shaped in Chattogram for the way you
              live.
            </SectionHeading>
          </Reveal>
        </div>
        ...
        <Reveal delay={200} className="relative z-[1]">
          <div className="mt-20 sm:mt-28 border-t border-[var(--line)] pt-12 grid grid-cols-2 sm:grid-cols-4 gap-8 sm:gap-0">
            {stats.map((stat, i) => (
              ...
              >
                <p className="serif text-4xl sm:text-5xl text-[var(--deep-brown)]">
                  {stat.value}
                </p>
