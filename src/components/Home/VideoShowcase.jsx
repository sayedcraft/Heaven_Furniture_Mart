      ...
      <div className="relative aspect-video w-full overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-[0.58rem] font-bold uppercase tracking-[0.22em] text-white/70">
        ...
        >
          ...
          <p className="mt-6 max-w-md text-sm leading-7 text-white/70 sm:mt-7">
        ...
        <div className="absolute bottom-10 right-8 z-10 sm:bottom-14 sm:right-12 lg:bottom-20 lg:right-16">
          <button
            type="button"
            onClick={toggleMute}
          ...
          >
            ...
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              {muted ? (
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.536 8.464a5 5 0 010 7.072M12 6v12M9 8.464a5 5 0 000 7.072M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15z" />
              )}
            </svg>
