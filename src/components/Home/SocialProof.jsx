...
export default function SocialProof() {
  return (
    <section className="border-t border-[var(--line)] bg-[var(--ivory)] py-28 sm:py-40 lg:py-52">
          ...
          <Reveal delay={150} className="lg:col-span-7">
            <div>
              ...
              <blockquote className="mb-12">
                <p className="serif text-2xl leading-[1.2] text-[var(--deep-brown)] sm:text-3xl lg:text-4xl">
                  &ldquo;At Heaven Furniture Mart, we believe furniture is more
                  than just function; it is a reflection of lifestyle, taste,
                  and comfort. Every piece we create is designed to bring
                  lasting elegance into the homes of our clients.&rdquo;
                </p>
              </blockquote>
              ...
              <div className="border-t border-[var(--line)] pt-8">
                <p className="text-xs font-bold uppercase tracking-[0.15em] text-[var(--brass)]">
                  Trusted by hundreds of happy homeowners across Chattogram and
                  beyond
                </p>
              </div>
            </div>
