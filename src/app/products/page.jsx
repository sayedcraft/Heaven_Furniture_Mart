...
export default function Products() {
  return (
    <main className="bg-[var(--ivory)] px-4 pb-16 pt-24 sm:px-6 sm:pt-24 md:px-8 lg:px-12 lg:pb-20 lg:pt-28">
      <div className="mx-auto w-full max-w-[1400px]">
        <header className="mb-10 max-w-3xl sm:mb-14 lg:mb-20">
          <h1 className="serif mt-3 text-[2.65rem] leading-[0.9] text-[var(--deep-brown)] sm:text-5xl md:text-6xl lg:text-7xl">
            Furniture for{" "}
